---
title: Deploy a PHP application on EC2 with Github and AWS CodePipeline
summary: >-
  Automate the delivery and deployment of a PHP application on Github to your
  EC2 instance using AWS Codepipeline
date: '2019-01-21T09:15:50.654Z'
categories: []
images: ['/images/1__SlpkTD9Hu8ttsxZGoj8X3Q.png']
tags: ['AWS', 'PHP', 'EC2', 'CI-CD', 'Code Pipeline']
keywords: [AWS, PHP, EC2, CI-CD, Code Pipeline]
slug: >-
  /deploy-a-php-application-on-ec2-with-github-and-aws-codepipeline-fb38cf204cbb
---
 
![](/images/1__SlpkTD9Hu8ttsxZGoj8X3Q.png)
...
![](/images/1__zH7UEYYtvaYYpW6r3qPbHA.gif)
...
![](/images/1__K3clP__BUgIhuRI32MirI1g.png)
...
#### Create S3 Access Role for EC2 Instance
...
![](/images/1__FMo7hmS__iN6a3cxCZz__zxA.png)

Select **EC2** and click next.

![](/images/1__EXMJ4t66FyuIBogQ4uTWtw.png)

Search for “s3" then select **AmazonS3FullAccess**.

![](/images/1__687paaAbPA6s3yyV5bT2EA.png)
...
![](/images/1__DzTMKKoxY2uJ__0tzeHYcDw.png)

Click on **Get Started** and Select **Custom Deployment**. Skip Walkthrough.

![](/images/1__52lS6cF3k8KfP1h2TJBu3Q.png)
...
![](/images/1__GwfokHWuSrVMwLcqTVLV4A.png)
...
![](/images/1__v4y0Z__iMNeDyDJy2qZikzg.png)
...
![](/images/1__ZMjC9gR1T839Jp5Bs3IJRA.png)
...
![](/images/1__stNj__KQcVx17w2gaNnJ9hA.png)
